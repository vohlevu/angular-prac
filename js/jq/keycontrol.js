...
/**
 * The current state of the KeyController. True if is block press key and return
 * for events.
 * @type boolean
 * @private
 */
gtv.jq.KeyController.prototype.isBlockKey = null;
...
gtv.jq.KeyController.prototype.keyDown_ = function(e) {
  ...
  if(keyController.isBlockKey) return;
  
  //Authentication.Debug("gtv.jq.KeyController.prototype.keyDown_: "+ e.keyCode);
